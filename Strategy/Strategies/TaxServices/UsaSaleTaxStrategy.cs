...
{
    public class UsaSaleTaxCalculationStrategy : ISaleTaxStrategy
    {
        private const decimal VATFoodTax = 0.2m;
        private const decimal VATElectronicDeviceTax = 0.5m;
        private const decimal VATBookTax = 0.05m;
        private const decimal VATServiceTax = 0.1m;
        private const decimal ImportTax = 0.15m;
